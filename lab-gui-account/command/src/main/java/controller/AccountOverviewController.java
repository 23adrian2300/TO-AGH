...
public class AccountOverviewController {
    ...
    private void handleDeleteAction(ActionEvent event) {
        var transactionsToRemove = List.copyOf(transactionsTable.getSelectionModel()
                .getSelectedItems());
        var removeTransactionsCommand = new RemoveTransactionsCommand(transactionsToRemove, data);
    ...
    private void handleAddAction(ActionEvent event) {
        ...
        if (appController.showTransactionEditDialog(transaction)) {
            var addTransactionCommand = new AddTransactionCommand(transaction, data);
